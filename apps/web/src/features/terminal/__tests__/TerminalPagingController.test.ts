...
import { TerminalPagingController, binaryStringToBytes, inputStringToBytes } from "../TerminalPagingController";
...
describe("TerminalPagingController", () => {
  ...
  beforeEach(() => {
    ...
    controller.setTerminal(mockTerm as any);
  });
  ...
  it("processFrame history writes bytes to terminal and suppresses input", () => {
    ...
    controller.setTerminal(term as any);
